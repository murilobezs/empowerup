...
EmpowerUp é uma plataforma social para empreendedoras com trilhas de aprendizado, comunidade, eventos ao vivo e ferramentas de crescimento. A interface web é construída em React + Vite e consome a API PHP da pasta `api/`.
